...
func publicationTestManifest() releasecontract.ArtifactManifest {
	...
	return releasecontract.ArtifactManifest{
		...
		MicroVM:       releasecontract.MicroVMArtifact{Identity: identity, ImageReference: releasecontract.MicroVMImage + "@" + digest, SignedManifestDigest: digest, SigningKeyFingerprint: "SHA256:" + strings.Repeat("A", 64), RuntimeBundle: releasecontract.SignedComponent{ArtifactID: "test-runtime", ManifestDigest: "sha256:" + strings.Repeat("2", 64), MandatoryGuestFeatures: []string{}}, ToolchainBundle: releasecontract.SignedComponent{ArtifactID: "test-toolchain", ManifestDigest: "sha256:" + strings.Repeat("3", 64), MandatoryGuestFeatures: []string{}}},
