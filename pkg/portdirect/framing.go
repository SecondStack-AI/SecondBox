...
//
// The privileged Runner owns an identical definition in its own module. The two
// are separate because the Runner module deliberately shares no dependency
// graph with the control plane, the same reason the generated protocol code is
// duplicated. Any change here must be mirrored in
// runner/internal/portdirect/framing.go.
package portdirect
