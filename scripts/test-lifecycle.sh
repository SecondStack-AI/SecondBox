...
export SECONDBOX_SCENARIO_SUBJECT_MAX_VCPU_COUNT
SECONDBOX_SCENARIO_SUBJECT_MAX_VCPU_COUNT="$(jq -er '.subjectMaxVcpuCount' "$SECONDBOX_LIFECYCLE_CONFIG")"
...
SECONDBOX_SCENARIO_MAX_CONCURRENT_WORKSPACE_CREATES="$(
  jq -er '.runner.maxConcurrentWorkspaceCreates' "$SECONDBOX_LIFECYCLE_CONFIG"
)"
