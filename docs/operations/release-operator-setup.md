...
just release-candidate 0.10.0 /protected/releases/installer-candidate
...
just release-stage 0.10.0 /protected/releases/secondbox-0.10.0
git push origin refs/tags/v0.10.0
just release-upload 0.10.0 /protected/releases/secondbox-0.10.0
```
