...
just release-candidate 0.8.0 /protected/releases/installer-candidate
...
just release-stage 0.8.0 /protected/releases/secondbox-0.8.0
just release-upload 0.8.0 /protected/releases/secondbox-0.8.0
```
