...
just release-candidate 0.8.2 /protected/releases/installer-candidate
...
just release-stage 0.8.2 /protected/releases/secondbox-0.8.2
just release-upload 0.8.2 /protected/releases/secondbox-0.8.2
```
