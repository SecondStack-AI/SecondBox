...
- `release-qualification`: apply the same review and branch restrictions, allow only qualified hosts in the `secondbox-release` Runner group, and define `SECONDBOX_RELEASE_QUALIFICATION_RESULTS_DIRECTORY` as the canonical absolute directory containing the six real artifact-backed records.
