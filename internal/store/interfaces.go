...
var (
	...
	_ service.ArtifactStore                = (*PostgresControlPlaneStore)(nil)
	_ service.ObservabilityStore           = (*PostgresControlPlaneStore)(nil)
	_ lifecycle.ReconcileStore             = (*PostgresControlPlaneStore)(nil)
	_ lifecycle.CheckpointPublicationStore = (*PostgresControlPlaneStore)(nil)
	_ lifecycle.GarbageCatalog             = (*PostgresControlPlaneStore)(nil)
)
