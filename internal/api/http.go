...
func NewHandler(config HandlerConfig) (http.Handler, error) {
	...
	mux.Handle("PUT /v1/tenants/{tenantRef}/quota", apiHandler.authenticatePlatformManagement(http.HandlerFunc(apiHandler.updateTenantQuota)))
	...
	mux.Handle("GET /v1/subjects/{subjectRef}/sandbox-policy", apiHandler.authenticateTenantControllerManagement(http.HandlerFunc(apiHandler.getSubjectSandboxPolicy)))
	mux.Handle("PUT /v1/subjects/{subjectRef}/sandbox-policy", apiHandler.authenticateTenantControllerManagement(http.HandlerFunc(apiHandler.updateSubjectSandboxPolicy)))
	...
	mux.Handle("GET /v1/subject-policy", apiHandler.authenticate(http.HandlerFunc(apiHandler.getApplicationSandboxPolicy)))
	mux.Handle("GET /v1/subject-usage", apiHandler.authenticate(http.HandlerFunc(apiHandler.getSubjectCapacity)))
