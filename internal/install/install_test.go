...
func TestPlanRejectsUnsafePathsEnumsAndDigests(t *testing.T) {
	...
	}{{"root path", func(p *InstallPlan) { p.Storage.WorkspacePath = "/" }}, {"glob path", func(p *InstallPlan) { p.Paths[0].Path = "/srv/*" }}, {"relative path", func(p *InstallPlan) { p.Paths[0].Path = "relative" }}, {"invalid storage", func(p *InstallPlan) { p.Storage.Choice = "disk" }}, {"malformed digest", func(p *InstallPlan) { p.Release.ArtifactManifestDigest = "sha256:no" }}, {"unsupported schema", func(p *InstallPlan) { p.SchemaVersion = "v2" }}}
