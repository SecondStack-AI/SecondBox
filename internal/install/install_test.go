...
func TestPlanRejectsUnsafePathsEnumsAndDigests(t *testing.T) {
	...
	}}, {"invalid storage", func(p *InstallPlan) { p.Storage.Choice = "disk" }}, {"malformed digest", func(p *InstallPlan) { p.Release.ArtifactManifestDigest = "sha256:no" }}, {"unsupported schema", func(p *InstallPlan) { p.SchemaVersion = "v2" }}}
