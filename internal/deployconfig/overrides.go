...
func OverrideRegistry() []OverrideDefinition {
	...
	definitions := []OverrideDefinition{
		...
		{"runner_command_poll_interval_milliseconds", "SECONDBOX_RUNNER_COMMAND_POLL_INTERVAL_MILLISECONDS", "", "Runner command fallback polling cadence.", false, "RunnerCommandPollIntervalMilliseconds"},
