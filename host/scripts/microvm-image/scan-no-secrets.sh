...
patterns='(^[[:space:]]*-{5}BEGIN [A-Z ]*PRIVATE KEY-{5}|AGENT_PLATFORM_TOKEN=|AG_AGENT_RUNTIME_AUTH_SECRET=|xox[baprs]-[A-Za-z0-9-]{10,}|github_pat_[A-Za-z0-9_]{20,}|glpat-[A-Za-z0-9_-]{20,})'
scan_out="/tmp/agentcy-microvm-secret-scan.$$"
